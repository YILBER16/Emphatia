...
4. `documentacion/aprendizaje/checklists/sprint-1/checklist-C.md` completada
5. Recordatorio escrito: C no escribe la DB de B; solo B llama a C
...
- [ ] Checklist de integración Sprint 1 en verde
